...
const Accident = () => {
  ...
  const [toolbox_train, setToolboxTrain] = useState('true');
  ...
  const handleSubmit = async (event) => {
    ...
    const formData = {
      ...
      about_the_accident,
      whitelevel,
      reported_by: reported_by.map(({ employee, employee_name,name }) => ({
        employee,
        employee_name,
        name
      })),
              ...
              {accident_type && (
                <Grid container spacing={2}>
                  <Grid item xs={12}>
                    ...
                    <Training1 onEmployeesChange={(updatedRows) => handleInputChange('reported_by', updatedRows)} />
                  </Grid>
                  <Grid item xs={12}>
                    <Typography gutterBottom>Workmen Involved:</Typography>
                    <Training1 onEmployeesChange={(updatedRows) => handleInputChange('workmen', updatedRows)} />
                  </Grid>
                  <Grid item xs={12}>
